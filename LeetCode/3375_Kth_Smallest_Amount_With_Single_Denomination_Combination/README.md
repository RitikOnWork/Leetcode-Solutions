...
[LeetCode - Kth Smallest Amount With Single Denomination Combination](https://leetcode.com/problems/kth-smallest-amount-with-single-denomination-combination/)
...
Return the `k^t^h` **smallest** amount that can be made using these coins.
