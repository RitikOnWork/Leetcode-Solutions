...
[LeetCode - Minimum Moves to Clean the Classroom](https://leetcode.com/problems/minimum-moves-to-clean-the-classroom/)
...
**Input:** <span class="example-io">classroom = ["S.", "XL"], energy = 2</span>
...
**Input:** <span class="example-io">classroom = ["LS", "RL"], energy = 4</span>
...
**Input:** <span class="example-io">classroom = ["L.S", "RXL"], energy = 3</span>
